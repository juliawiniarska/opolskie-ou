...
export default function AboutPage() {
  ...
  // Zmienna z meta tagami, którą renderujemy niezależnie od stanu ładowania
  const helmetContent = (
    <Helmet>
  ...
  // Jeśli trwa ładowanie, zwracamy Helmet + Loader
  if (isLoading) {
    return (
      <>
        {helmetContent}
  ...
  // Jeśli załadowane, zwracamy Helmet + całą treść strony
  return (
    <>
      {helmetContent}
