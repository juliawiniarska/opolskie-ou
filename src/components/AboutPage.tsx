    ...
    <main className="bg-[#F5F1E8]">
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-[#F5F1E8]">
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-16 space-y-10 sm:space-y-14 lg:space-y-16">
          ...
          {/* BLOK 2: po LEWEJ pole, po PRAWEJ zdjęcie (desktop) */}
<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
  {/* LEFT: Jak pomagamy (na desktop lewa strona) */}
  ...
  {/* RIGHT: image 2 (na desktop prawa strona) */}
  ...
  <p className="mt-4 text-[#6B6B6B] leading-relaxed">
    Stawiamy na uczciwość i działamy w interesie klienta. Polecamy rozwiązania sprawdzone, czytelne
    i dopasowane do realnych potrzeb — bez naciągania i bez niedopowiedzeń. Zawsze mówimy wprost o
    warunkach, wyłączeniach i ograniczeniach, żebyś miał(a) pełen obraz przed podjęciem decyzji.
  </p>

  <p className="mt-4 text-[#6B6B6B] leading-relaxed">
    Słuchamy, doradzamy i tłumaczymy po ludzku — bo dobra współpraca zaczyna się od zrozumienia.
  </p>
</div>
