...
type CalcPageACF = {
  ...
  calc_meta_title?: string; // Dodałem pole dla ACF (opcjonalne)
  [key: string]: any; 
};
...
export default function InsuranceCalculatorPage() {
  ...
  const helmetContent = (
    <Helmet defer={false}>
      ...
      <meta name="description" content={texts?.calc_hero_desc || "Oblicz składkę ubezpieczeniową online. Szybki kalkulator ubezpieczeń OC, AC, majątkowych i na życie. Zobacz oferty wielu towarzystw ubezpieczeniowych w jednym miejscu."} />
    </Helmet>
  );
