...
export default function OfertaPage() {
  ...
  // LOGIKA SEO
  const pageTitle = texts?.offer_meta_title || "Oferta ubezpieczeń | Opolskie Ubezpieczenia";
  ...
  const helmetContent = (
    <Helmet defer={false}>
      ...
      <meta name="description" content={texts?.offer_hero_desc || "Sprawdź naszą ofertę ubezpieczeń komunikacyjnych, majątkowych, na życie, firmowych i turystycznych w Nysie."} />
    </Helmet>
  );
